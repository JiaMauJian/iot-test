...
{             //This function will read and remember two NMEA sentences from GPS
  ...
  do
  {
    ...
    //u8g.drawStr(0, 8, "latitude : ");
    u8g.drawStr(0, 8, String(GPS.latitudeDegrees, 4).c_str());    

    //u8g.drawStr(0, 16, "longitude : ");
    u8g.drawStr(0, 16, String(GPS.longitudeDegrees, 4).c_str());    
